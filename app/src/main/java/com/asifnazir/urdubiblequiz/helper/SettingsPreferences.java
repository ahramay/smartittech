package com.asifnazir.urdubiblequiz.helper;
...
public class SettingsPreferences {
    ...
    public static final String QuizActivity = "level_completed";

    public static final String IS_Quiz_COMPLETED = "is_last_level_completed";
    ...
    public static void setNoCompletedQuiz(Context context, int completedQuiz) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor prefEditor = prefs.edit();
        prefEditor.putInt(QuizActivity, completedQuiz);
        prefEditor.commit();
    }
    ...
    public static int getNoCompletedLevel(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getInt(QuizActivity, 1);
